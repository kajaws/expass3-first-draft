...
public class PollAppTest {
    ...
    public void testScenarioFlow() throws Exception {
        ...
        mockMvc.perform(post("/polls")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{ \"pollId\": 1, \"username\": \"user1\", \"question\": \"What is your favorite color?\", \"publishedAt\": \"2024-09-03T12:00:00Z\", \"validUntil\": \"2024-09-10T12:00:00Z\", " +
                                 "\"voteOption\": [{ \"voteOptionId\": 1, \"caption\": \"Red\", \"presentationOrder\": 1 }, " +
        ...
        mockMvc.perform(get("/polls"))
                .andExpect(status().isOk())
                .andExpect(content().json("[{ \"pollId\": 1, \"username\": \"user1\", \"question\": \"What is your favorite color?\", \"publishedAt\": \"2024-09-03T12:00:00Z\", \"validUntil\": \"2024-09-10T12:00:00Z\", " +
                                         "\"voteOption\": [{ \"voteOptionId\": 1, \"caption\": \"Red\", \"presentationOrder\": 1 }, " +
                                        "{ \"voteOptionId\": 2, \"caption\": \"Green\", \"presentationOrder\": 2 }, " +
                                        "{ \"voteOptionId\": 3, \"caption\": \"Blue\", \"presentationOrder\": 3 }] }]"));
        ...
        mockMvc.perform(post("/votes")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"username\": \"user2\", \"pollId\": 1, \"publishedAt\": \"2024-09-03T12:00:00Z\", \"voteOptionId\": 3}"))
                .andExpect(status().isOk());

        // User 2 changes his vote
        mockMvc.perform(post("/votes")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"username\": \"user2\", \"pollId\": 1, \"publishedAt\": \"2024-09-03T12:00:00Z\", \"voteOptionId\": 1}"))
                .andExpect(status().isOk());

        // List all votes (should show the most recent vote for User 2)
        mockMvc.perform(get("/votes"))
                .andExpect(status().isOk())
                .andExpect(content().json("[{ \"username\": \"user2\", \"pollId\": 1, \"publishedAt\": \"2024-09-03T12:00:00Z\", \"voteOptionId\": 1 }]"));
